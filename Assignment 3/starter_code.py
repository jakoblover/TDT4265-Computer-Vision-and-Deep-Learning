...
class ExampleModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.feature_extractor = nn.Sequential(
            nn.Conv2d(
                in_channels = image_channels*32*32,
                out_channels = num_filters*32*32,
                kernel_size=5,
                stride=1,
                padding=2
            ),
            ...
            nn.Conv2d(
                in_channels=num_filters*16*16,
                out_channels=num_filters*2*16*16,
                kernel_size=5,
                stride=1,
                padding=2
            ),
            ...
            nn.MaxPool2d(kernel_size=2, stride=2),
            nn.Conv2d(
                in_channels=num_filters*2*8*8,
                out_channels=num_filters*4*8*8,
                kernel_size=5,
                stride=1,
                padding=2
            ),
